...
h4=plot(1914:2014,taueqm(1:end-1),'color',green2,'linewidth',3);
...
hhh1=legend([h3 h4],'$\widetilde{\tau}_{1\%} \left(t\right)$','$\tau^{\textrm{eqm}}_{1\%} \left(t\right)$');
...
plot(1913:2014,top_1_reprod_eqm,'color',green2,'linewidth',3);
grid off;
box off
...
hhh4=legend('$S^{\textrm{data}}_{1\%} \left(t\right)$','$S^{\textrm{model}}_{1\%} \left(t,\tau_{1\%} \left(t\right)\right)$','$S^{\textrm{model}}_{1\%} \left(t,\tau^{\textrm{eqm}}_{1\%} \left(t\right)\right)$');
